...
def on_ui_settings():
    shared.options_templates.update(shared.options_section(('uiux_core', "UI-UX"), {
        'uiux_separator_appearance': shared.OptionInfo("<h2>Appearance</h2>", "", gr.HTML),
        "uiux_no_slider_layout": shared.OptionInfo(False, "Hide input range sliders"),
        ...
        "uiux_no_headers_params": shared.OptionInfo(False, "Hide params headers"),
        "uiux_show_outline_params": shared.OptionInfo(True, "Show parameter outline"),

        'uiux_separator_mobile': shared.OptionInfo("<h2>Mobile</h2>", "", gr.HTML),
        ...
        'uiux_separator_other': shared.OptionInfo("<h2>Other Settings</h2>", "", gr.HTML),
